...
describe('sighash', function () {
  it('should be able to compute sighash for a coinbase tx', function () {
    ...
    var sighash = Transaction.Sighash.sighash(tx, Signature.SIGHASH_ALL, 0, Script.empty());
    sighash
      .toString('hex')
      .should.equal('6829f7d44dfd4654749b8027f44c9381527199f78ae9b0d58ffc03fdab3c82f1');
  });
