...
var SIGHASH_SINGLE_BUG = Buffer.from(
...
var sighashPreimageForForkId = function (
  transaction,
  sighashType,
  inputNumber,
  subscript,
  ...
  if (!(sighashType & Signature.SIGHASH_ANYONECANPAY)) {
    hashPrevouts = hashCache.prevoutsHashBuf
      ...
      : (hashCache.prevoutsHashBuf = GetPrevoutHash(transaction));
  }
  ...
  if (
    ...
    hashSequence = hashCache.sequenceHashBuf
      ...
      : (hashCache.sequenceHashBuf = GetSequenceHash(transaction));
  }
  ...
  if (
    ...
    hashOutputs = hashCache.outputsHashBuf
      ...
      : (hashCache.outputsHashBuf = GetOutputsHash(transaction));
  } else if (
    (sighashType & 31) === Signature.SIGHASH_SINGLE &&
 ...
 *
 */
var sighashPreimage = function sighashPreimage(
  transaction,
  sighashType,
  inputNumber,
  subscript,
