...
ECIES.prototype.decrypt = function (encbuf) {
  ...
  if (!this.opts.noKey) {
    ...
    if (this.opts.fixedPublicKey)
      console.log(
        'Notice: Overriding PublicKey in message. Consider use "noKey" option if you are not sending message to electrum and do not want to use ephemeral key',
      );
