...
export class ScryptFileParser {
  ...
  static parseImportExpression(fileContent: string): ImportExpression[] {
    ...
    /*
      ...
      import "@opcat-labs/scrypt-ts-transpiler/assets/smart-contract/types/structs.scrypt";
      import "@opcat-labs/scrypt-ts-transpiler/assets/smart-contract/builtin-libs/txUtils.scrypt";
    */
