...
/**
 * Invalid contract: accesses ctx.hashOutputs with ANYONECANPAY_NONE
 * This should throw a transpiler error because hashOutputs is empty
 * in NONE mode.
 */
export class SighashAnyonecanpayNoneHashOutputs extends SmartContract {
  @method({ sigHashType: SigHashType.ANYONECANPAY_NONE })
  public unlock(sig: Sig, pubKey: PubKey) {
    // This should cause a transpiler error:
    // ctx.hashOutputs cannot be accessed with sighash ANYONECANPAY_NONE
