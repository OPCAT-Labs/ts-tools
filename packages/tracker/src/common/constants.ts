...
export class Constants {
  ...
  static readonly GUARD_MAX_TOKEN_TYPES = 4;

  static readonly FT_GUARD_INPUT_CUR_STATE_OFFSET = 50;
  static readonly FT_GUARD_INPUT_CUR_STATE_TOKEN_SCRIPT_OFFSET =
    this.FT_GUARD_INPUT_CUR_STATE_OFFSET + this.CONTRACT_INPUT_MAX_COUNT;
  static readonly FT_GUARD_INPUT_CUR_STATE_TOKEN_AMOUNT_OFFSET =
    this.FT_GUARD_INPUT_CUR_STATE_TOKEN_SCRIPT_OFFSET + this.GUARD_MAX_TOKEN_TYPES;
  static readonly FT_GUARD_INPUT_CUR_STATE_BURN_AMOUNT_OFFSET =
    this.FT_GUARD_INPUT_CUR_STATE_TOKEN_AMOUNT_OFFSET + this.GUARD_MAX_TOKEN_TYPES;
  static readonly FT_GUARD_INPUT_CUR_STATE_SCRIPT_INDEX_OFFSET =
    this.FT_GUARD_INPUT_CUR_STATE_BURN_AMOUNT_OFFSET + this.GUARD_MAX_TOKEN_TYPES;
  static readonly FT_GUARD_INPUT_WITNESS_MIN_SIZE =
    this.FT_GUARD_INPUT_CUR_STATE_SCRIPT_INDEX_OFFSET + this.CONTRACT_INPUT_MAX_COUNT;

  static readonly NFT_GUARD_INPUT_CUR_STATE_OFFSET = 50;
  static readonly NFT_GUARD_INPUT_CUR_STATE_NFT_SCRIPT_OFFSET =
    this.NFT_GUARD_INPUT_CUR_STATE_OFFSET + this.CONTRACT_INPUT_MAX_COUNT;
  static readonly NFT_GUARD_INPUT_CUR_STATE_BURN_MASK_OFFSET =
    this.NFT_GUARD_INPUT_CUR_STATE_NFT_SCRIPT_OFFSET + this.GUARD_MAX_TOKEN_TYPES;
  static readonly NFT_GUARD_INPUT_CUR_STATE_SCRIPT_INDEX_OFFSET =
    this.NFT_GUARD_INPUT_CUR_STATE_BURN_MASK_OFFSET + this.CONTRACT_INPUT_MAX_COUNT;
  static readonly NFT_GUARD_INPUT_WITNESS_MIN_SIZE =
    this.NFT_GUARD_INPUT_CUR_STATE_SCRIPT_INDEX_OFFSET + this.CONTRACT_INPUT_MAX_COUNT;

  static readonly GUARD_INPUT_WITNESS_MIN_SIZE = Math.max(
    this.FT_GUARD_INPUT_WITNESS_MIN_SIZE,
    this.NFT_GUARD_INPUT_WITNESS_MIN_SIZE,
  );

  static readonly QUERY_PAGING_DEFAULT_OFFSET = 0;
  static readonly QUERY_PAGING_DEFAULT_LIMIT = 100;
  static readonly QUERY_PAGING_MAX_LIMIT = 10000;
