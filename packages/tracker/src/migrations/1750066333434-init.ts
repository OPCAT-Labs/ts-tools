...
export class Init1750066333434 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
     await queryRunner.query(`CREATE TABLE "tx_out_archive" ("txid" character varying(64) NOT NULL, "output_index" integer NOT NULL, "block_height" integer NOT NULL DEFAULT '2147483647', "satoshis" bigint NOT NULL, "locking_script_hash" character varying NOT NULL, "is_from_mint" boolean NOT NULL, "owner_pkh" character varying, "token_amount" bigint, "data" character varying NOT NULL, "spend_txid" character varying, "spend_input_index" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_80e1532f0cc61b9408923c710d3" PRIMARY KEY ("txid", "output_index"))`);
        ...
        await queryRunner.query(`CREATE TABLE "tx_out" ("txid" character varying(64) NOT NULL, "output_index" integer NOT NULL, "block_height" integer NOT NULL DEFAULT '2147483647', "satoshis" bigint NOT NULL, "locking_script_hash" character varying NOT NULL, "is_from_mint" boolean NOT NULL, "owner_pkh" character varying, "token_amount" bigint, "data" character varying NOT NULL, "spend_txid" character varying, "spend_input_index" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "update_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bf339c207c55632c1b44cb4dcce" PRIMARY KEY ("txid", "output_index"))`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_bfb80f86207bfba4dcfdba8406" ON "tx_out" ("locking_script_hash", "owner_pkh") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "IDX_4bb884940e61aa867fc229d5da" ON "tx_out" ("spend_txid", "spend_input_index") `);
        await queryRunner.query(`CREATE TABLE "tx" ("txid" character varying(64) NOT NULL, "block_height" integer NOT NULL, "tx_index" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e5bf84e0e897ce668b82ca3f833" PRIMARY KEY ("txid"))`);
        await queryRunner.query(`CREATE INDEX "IDX_dda1249bcfce884c26070b1f96" ON "tx" ("block_height") `);
        await queryRunner.query(`CREATE TABLE "token_info" ("token_id" character varying NOT NULL, "genesis_txid" character varying NOT NULL, "name" character varying NOT NULL, "symbol" character varying NOT NULL, "decimals" integer NOT NULL, "raw_info" character varying NOT NULL, "minter_script_hash" character varying(64), "token_script_hash" character varying(64), "first_mint_height" integer, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "premine" integer, "token_limit" bigint, "deploy_block" integer, "deploy_txid" character varying, "deploy_time" integer, "logo_url" character varying, CONSTRAINT "PK_84c0d8366cd8317811709c9e3f4" PRIMARY KEY ("token_id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_c22e5423743e6c29055aee529b" ON "token_info" ("genesis_txid") `);
        await queryRunner.query(`CREATE INDEX "IDX_4d9c75a2665bcbbce162992281" ON "token_info" ("minter_script_hash") `);
        await queryRunner.query(`CREATE INDEX "IDX_7eb09facfd01317d466560b3a8" ON "token_info" ("token_script_hash") `);
        await queryRunner.query(`CREATE INDEX "IDX_899a44411763b33029cd4231cd" ON "token_info" ("first_mint_height") `);
        await queryRunner.query(`CREATE TABLE "token_mint" ("txid" character varying(64) NOT NULL, "token_script_hash" character varying(64) NOT NULL, "block_height" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "token_amount" bigint, CONSTRAINT "PK_21865bb90d676d5e24693eccf55" PRIMARY KEY ("txid"))`);
        await queryRunner.query(`CREATE INDEX "IDX_a61016e1381ef1fcda68fd7a0e" ON "token_mint" ("token_script_hash") `);
        await queryRunner.query(`CREATE INDEX "IDX_630181ee96ff88d9341cebdaae" ON "token_mint" ("block_height") `);
        await queryRunner.query(`CREATE TABLE "nft_info" ("collection_id" character varying NOT NULL, "local_id" bigint NOT NULL, "mint_txid" character varying(64) NOT NULL, "mint_height" integer NOT NULL, "commit_txid" character varying(64) NOT NULL, "metadata" jsonb, "content_type" character varying, "content_encoding" character varying, "content_raw" bytea, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e1eaf4029498024bfc744325bb8" PRIMARY KEY ("collection_id", "local_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "block" ("hash" character varying(64) NOT NULL, "height" integer NOT NULL, "n_tx" integer NOT NULL DEFAULT '0', "time" integer NOT NULL, "previous_hash" character varying(64), "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_f8fba63d7965bfee9f304c487aa" PRIMARY KEY ("hash"))`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "public"."IDX_bce676e2b005104ccb768495db"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_a61016e1381ef1fcda68fd7a0e"`);
        await queryRunner.query(`DROP TABLE "token_mint"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_899a44411763b33029cd4231cd"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_7eb09facfd01317d466560b3a8"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_4d9c75a2665bcbbce162992281"`);
