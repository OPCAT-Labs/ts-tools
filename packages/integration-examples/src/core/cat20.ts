...
export class CatTrackerApi {
    ...
    async getAddressTokenBalanceList(address: string): Promise<{ balances: CatTrackerTokenBalance[], trackerBlockHeight: number }> {
...
function isCat20TokenSupported(token: CatTrackerToken) {
    ...
    const cat20 = new CAT20(token.minterScriptHash, guardScriptHash);
