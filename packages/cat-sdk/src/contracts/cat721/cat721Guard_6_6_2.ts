...
The file cat721Guard_6_6_2.js is generated by `npm run gen:guard`, do not modify this file

*/

import { ConstantsLib, NFT_GUARD_COLLECTION_TYPE_MAX_2, NFT_GUARD_COLLECTION_TYPE_MAX, OUTPUT_LOCKING_SCRIPT_HASH_LEN, TX_INPUT_COUNT_MAX_6, TX_OUTPUT_COUNT_MAX_6 } from "../constants.js";
 ...
 * @onchain
 */
@tags([CatTags.CAT721_GUARD_TAG, CatTags.CAT721_GUARD_6_6_2_TAG])
export class CAT721Guard_6_6_2 extends SmartContract<CAT721GuardConstState> {
     ...
     */
    @unlock(CAT721Guard_6_6_2, 'unlock')
    static unlockUnlock(ctx: UnlockContext<CAT721Guard_6_6_2, CAT721GuardUnlockParams>): void {
