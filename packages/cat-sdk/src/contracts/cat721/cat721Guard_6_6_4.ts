...
import { ConstantsLib, NFT_GUARD_COLLECTION_TYPE_MAX_4, NFT_GUARD_COLLECTION_TYPE_MAX, OUTPUT_LOCKING_SCRIPT_HASH_LEN, TX_INPUT_COUNT_MAX_6, TX_OUTPUT_COUNT_MAX_6 } from "../constants";
...
export class CAT721Guard_6_6_4 extends SmartContract<CAT721GuardConstState> {
    ...
    public unlock(
        ...
        CAT721GuardStateLib.formalCheckState6(this.state);
