...
The file cat721Guard_6_6_4.js is generated by `npm run gen:guard`, do not modify this file

*/

import { ConstantsLib, NFT_GUARD_COLLECTION_TYPE_MAX_4, NFT_GUARD_COLLECTION_TYPE_MAX, OUTPUT_LOCKING_SCRIPT_HASH_LEN, TX_INPUT_COUNT_MAX_6, TX_OUTPUT_COUNT_MAX_6 } from "../constants.js";
 ...
 * @onchain
 */
@tags([CatTags.CAT721_GUARD_TAG, CatTags.CAT721_GUARD_6_6_4_TAG])
export class CAT721Guard_6_6_4 extends SmartContract<CAT721GuardConstState> {
    @method()
    public unlock(
        ...
        //        correct             [20, 10, -1, -1, -1]
        //        invalid             [-1, 20, 10, -1, -1]
        outputLocalIds: FixedArray<bigint, typeof TX_OUTPUT_COUNT_MAX_6>,
        nftScriptHashIndexes: FixedArray<bigint, typeof TX_OUTPUT_COUNT_MAX_6>,
        outputSatoshis: FixedArray<bigint, typeof TX_OUTPUT_COUNT_MAX_6>,
        cat721States: FixedArray<CAT721State, typeof TX_INPUT_COUNT_MAX_6>,
        ...
        for (let i = 0; i < NFT_GUARD_COLLECTION_TYPE_MAX; i++) {
            if (i >= NFT_GUARD_COLLECTION_TYPE_MAX_4) {
        ...
        for (let i = 0; i < NFT_GUARD_COLLECTION_TYPE_MAX_4; i++) {
        ...
        const nextNfts: FixedArray<ByteString, typeof TX_OUTPUT_COUNT_MAX_6> = fill(toByteString(''), TX_OUTPUT_COUNT_MAX_6);
        let nextNftCount = 0n;
        const inputCount = this.ctx.inputCount;
        for (let i = 0n; i < TX_INPUT_COUNT_MAX_6; i++) {
        ...
        for (let i = 0n; i < TX_OUTPUT_COUNT_MAX_6; i++) {
            if (i < outputCount) {
                ...
                if (nftScriptIndex != -1n) {
                    ...
                    for (let j = 0; j < NFT_GUARD_COLLECTION_TYPE_MAX_4; j++) {
     ...
     */
    @unlock(CAT721Guard_6_6_4, 'unlock')
    static unlockUnlock(ctx: UnlockContext<CAT721Guard_6_6_4, CAT721GuardUnlockParams>): void {
