...
The file cat721Guard_12_12_4.js is generated by `npm run gen:guard`, do not modify this file

*/

import { ConstantsLib, NFT_GUARD_COLLECTION_TYPE_MAX_4, NFT_GUARD_COLLECTION_TYPE_MAX, OUTPUT_LOCKING_SCRIPT_HASH_LEN, TX_INPUT_COUNT_MAX_12, TX_OUTPUT_COUNT_MAX_12 } from "../constants.js";
 ...
 * @onchain
 */
@tags([CatTags.CAT721_GUARD_TAG, CatTags.CAT721_GUARD_12_12_4_TAG])
export class CAT721Guard_12_12_4 extends SmartContract<CAT721GuardConstState> {
    @method()
    public unlock(
     ...
     */
    @unlock(CAT721Guard_12_12_4, 'unlock')
    static unlockUnlock(ctx: UnlockContext<CAT721Guard_12_12_4, CAT721GuardUnlockParams>): void {
