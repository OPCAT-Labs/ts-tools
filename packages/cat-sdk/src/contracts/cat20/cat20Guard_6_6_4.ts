...
The file cat20Guard_6_6_4.js is generated by `npm run gen:guard`, do not modify this file
 ...
 * @onchain
 */
@tags([CatTags.CAT20_GUARD_TAG, CatTags.CAT20_GUARD_6_6_4_TAG])
export class CAT20Guard_6_6_4 extends SmartContract<CAT20GuardConstState> {
    @method()
    public unlock(
        ...
        const sumOutputTokens = fill(0n, GUARD_TOKEN_TYPE_MAX_4)
        ...
        for (let i = 0; i < TX_OUTPUT_COUNT_MAX_6; i++) {
            if (i < outputCount) {
                ...
                if (tokenScriptHashIndex != -1n) {
                    ...
                    for (let j = 0; j < GUARD_TOKEN_TYPE_MAX_4; j++) {
     ...
     */
    @unlock(CAT20Guard_6_6_4, 'unlock')
    static unlockUnlock(ctx: UnlockContext<CAT20Guard_6_6_4, CAT20GuardUnlockParams>): void {
