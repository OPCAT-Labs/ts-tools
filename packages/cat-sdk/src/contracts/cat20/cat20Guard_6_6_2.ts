...
export class CAT20Guard_6_6_2 extends SmartContract<CAT20GuardConstState> {
     ...
     */
    @unlock(CAT20Guard_6_6_2, 'unlock')
    static unlockUnlock(ctx: UnlockContext<CAT20Guard_6_6_2, CAT20GuardUnlockParams>): void {
